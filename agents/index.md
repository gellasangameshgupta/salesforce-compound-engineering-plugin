...
| <span data-proof="authored" data-by="ai:claude">Business Analyst Pulse</span> | <span data-proof="authored" data-by="ai:claude">`sf-business-analyst-pulse.agent.md`</span> | <span data-proof="authored" data-by="ai:claude">Requirements traceability, adoption & business-process friction vs a live org (read-only)</span>                                                                                                                                                               |
...
* <span data-proof="authored" data-by="ai:claude">`sf-learnings-researcher`</span> <span data-proof="authored" data-by="ai:claude">keeps</span> <span data-proof="authored" data-by="ai:claude">`model: haiku`</span> <span data-proof="authored" data-by="ai:claude">for speed;</span> <span data-proof="authored" data-by="ai:claude">`sf-spec-flow-analyzer`</span> <span data-proof="authored" data-by="ai:claude">and</span> <span data-proof="authored" data-by="ai:claude">`sf-business-analyst-pulse`</span> <span data-proof="authored" data-by="ai:claude">keep</span> <span data-proof="authored" data-by="ai:claude">`model: sonnet`</span> <span data-proof="authored" data-by="ai:claude">for depth; all other agents use</span> <span data-proof="authored" data-by="ai:claude">`model: inherit`.</span>
